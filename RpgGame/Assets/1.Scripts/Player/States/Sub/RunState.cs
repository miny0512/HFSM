...
{
    public class RunState : Substate<Player.RootState, Player.SubState, Player>
    {
        public RunState(HierarchicalStateMachine<Player.RootState, Player.SubState, Player> sm, Player owner) : base(sm, owner)
        {
        }
        ...
        {
            owner.ReuseableData.CurrentMoveSpeed = owner.Data.Movement.MoveSpeed * owner.Data.Movement.RunMultiplier;
        }
